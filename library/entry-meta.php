...
if ( ! function_exists( 'pdxtheme_entry_meta' ) ) :
	function pdxtheme_entry_meta() {
		...
		e//cho '<cite class="float-left byline author">' . __( 'Written by', 'pdxtheme' ) . ' <a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '" rel="author" class="fn">' . get_the_author() . '</a></cite>';
	}
endif;
